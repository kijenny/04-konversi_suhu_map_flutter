...
import 'package:konversisuhu/widget/conversion_history.dart';
import 'package:konversisuhu/widget/dropdown_conversion.dart';
import 'package:konversisuhu/widget/result.dart';
import 'package:konversisuhu/widget/user_input.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Kirana Jenny Alqorni',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const Text('2031710086',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(
            height: 10,
          ),
